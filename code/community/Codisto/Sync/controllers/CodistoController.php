...
EOT;
	...
	private function renderPane($url, $class)
	{
		...
		{
			$block = $this->getLayout()->createBlock('core/text', 'green-block')->setText('<div id="codisto-control-panel-wrapper"><iframe id="codisto-control-panel" class="codisto-iframe register" src="'. htmlspecialchars(Mage::getModel('adminhtml/url')->getUrl('/codisto/register')) . '" frameborder="0" onmousewheel=""></iframe></div>');
